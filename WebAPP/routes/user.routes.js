...
router.post(
	...
	body('password', 'Password must be at least 8 characters long and include a lowercase letter, uppercase letter, number, and a symbol.').matches(/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z0-9]).{8,}$/, "i"),
